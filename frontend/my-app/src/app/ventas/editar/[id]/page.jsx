...
export default function EditarVenta({ params }) {
            ...
            if (id) {
                try {
                    const response = await axios.get(
                        `http://localhost:3000/ventas/buscarPorId/${id}`
                    );
                    ...
                    setProductoSeleccionado(ventaData.productoNombre || "");
    ...
    const buscarProductos = async (query) => {
        ...
        try {
            const respuesta = await axios.get("http://localhost:3000/productos/buscar", {
                params: { query },
            });
    ...
    const buscarClientes = async (query) => {
        ...
        const respuesta = await axios.get("http://localhost:3000/usuarios/buscar", {
            params: { query },
        });
